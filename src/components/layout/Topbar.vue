<template>
  <header
    class="flex justify-between items-center bg-white dark:bg-slate-900 px-2 md:px-3 py-1 text-gray-900 dark:text-white relative z-50 border border-gray-200 dark:border-slate-800 transition-colors theme w-full md:w-[97%] md:mx-auto md:mt-3 md:rounded-2xl"
  >
    <!-- LEFT -->
    <div class="flex items-center gap-1 md:gap-3 flex-1 md:w-96">
      <button
        @click="$emit('toggle-sidebar')"
        class="text-lg md:text-xl hover:text-gray-600 dark:hover:text-gray-400 transition-colors p-1 md:p-0 flex-shrink-0"
      >
        <svg
      ...
      <div
        class="hidden md:flex items-center gap-1 bg-gray-100 dark:bg-slate-800 px-3 py-1 rounded-md transition-colors w-96"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="1.5em"
    ...
    <div
      class="md:hidden flex items-center gap-1 bg-gray-100 dark:bg-slate-800 px-2 py-1 rounded-md transition-colors flex-1 mx-1"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1em"
      ...
      <input
        ...
        @input="$emit('update:searchQuery', $event.target.value)"
        placeholder="Search..."
        class="bg-transparent outline-none text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 transition-colors text-sm"
      />
    </div>
    ...
    <div class="flex items-center gap-2 md:gap-4">
      ...
      <button
        ...
        class="flex items-center justify-center w-8 md:w-10 h-8 md:h-10 rounded-lg bg-gray-100 dark:bg-slate-800 hover:bg-gray-200 dark:hover:bg-slate-700 transition-colors theme"
      ...
      <div class="relative cursor-pointer hidden sm:block" @click="toggleDropdownlang">
        <img
          src="../../assets/image/ukflag.webp"
          class="w-6 h-6 rounded-full hover:opacity-80 transition-opacity"
        />
        <div
        ...
        >
          <div
            class="flex items-center px-2 hover:bg-gray-100 dark:hover:bg-slate-700 rounded cursor-pointer"
          >
            <Icon icon="twemoji:flag-cambodia" />
            <p class="px-4 py-2 text-gray-900 dark:text-white text-sm">
              Cambodia
            </p>
          </div>
          <div
      ...
      <div>
        <button
          class="hover:opacity-75 transition-opacity text-xl relative top-1"
          @click="toggleCart"
        >
        ...
        <Transition name="slide">
          <div
            v-if="showCart"
            class="fixed top-0 right-0 h-full w-80 bg-white dark:bg-slate-900 shadow-2xl z-50 flex flex-col"
          >
            <div
            ...
            >
              ...
              <button
                class="hover:opacity-75 transition-opacity text-xl dark:text-white"
                @click="closeCart"
              >
                <Icon icon="mdi:close" />
              </button>
            ...
            <div class="flex-1 overflow-y-auto p-4 space-y-4">
              ...
              >
                ...
                <div class="flex items-center gap-2 flex-shrink-0">
                  <button
                    class="w-6 h-6 rounded-full border border-gray-300 dark:border-slate-600 flex items-center justify-center text-gray-500 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors text-xs"
                    @click="decreaseQty(item)"
                  >
                    −
                  </button>
                  <span
                    class="text-sm font-medium w-4 text-center dark:text-white"
                    >{{ item.qty }}</span
                  >
                  <button
                    class="w-6 h-6 rounded-full border border-gray-300 dark:border-slate-600 flex items-center justify-center text-gray-500 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors text-xs"
              ...
              <div
                ...
                class="flex flex-col items-center justify-center mt-16 gap-3"
              >
            ...
            <div
              v-if="cartItems.length > 0"
              class="px-4 pb-2 pt-2 border-t border-gray-100 dark:border-slate-700"
            >
              <div
            ...
            <div class="p-4 border-t dark:border-slate-700">
              <button
                class="w-full bg-black dark:bg-white dark:text-black text-white py-3 rounded-lg hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors"
              >
                Checkout
              </button>
            </div>
      ...
      <div class="relative top-1" @click="toggleNotification">
        ...
        <Transition name="dropdown">
          ...
          >
            <!-- Header -->
            <div
              class="flex items-center justify-between px-4 py-3 border-b dark:border-slate-700"
            >
            ...
            <!-- Notification List -->
            <div
              class="max-h-72 overflow-y-auto divide-y divide-gray-100 dark:divide-slate-700"
            >
              <div
              ...
              >
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <p class="text-xs text-gray-300 dark:text-slate-500 mt-1">
                    {{ notif.time }}
                  </p>
                </div>
                <!-- Unread dot -->
      ...
      <div class="relative cursor-pointer" @click="toggleDropdown">
        <img
          ...
          class="w-8 h-8 rounded-full hover:opacity-80 transition-opacity"
        />
        ...
        <Transition name="dropdown">
          ...
          >
            <!-- User Info -->
            <div
              class="px-4 py-3 border-b dark:border-slate-700 flex items-center gap-3"
            >
              <img
                src="../../assets/image/profile2.webp"
            ...
            <div class="py-1">
              <p
                class="flex items-center gap-3 px-4 py-2 hover:bg-gray-100 dark:hover:bg-slate-700 text-gray-700 dark:text-gray-200 text-sm cursor-pointer transition-colors"
              >
                <Icon
    ...
    return {
      ...
      cartItems: [
        ...
        },
        {
          ...
          qty: 1,
          image:
            "https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=120&q=80",
        },
      ],
    };
  },
